define(['exports', 'aurelia-pal', 'aurelia-dependency-injection', './ux-dialog-renderer'], function (exports, aureliaPal, aureliaDependencyInjection, uxDialogRenderer) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NativeDialogRenderer = (function () {
        ...
        NativeDialogRenderer.prototype.awaitTransition = function (setActiveInactive, ignore) {
            ...
            return new Promise(function (resolve) {
                var renderer = _this;
                var eventName = uxDialogRenderer.transitionEvent();
                ...
                if (ignore || !uxDialogRenderer.hasTransition(_this.dialogContainer)) {
                    resolve();
                }
                else {
    ...
    exports.NativeDialogRenderer = NativeDialogRenderer;
