define(["require", "exports", "./renderer", "./dialog-settings", "./dialog-renderer", "aurelia-pal"], function (require, exports, renderer_1, dialog_settings_1, dialog_renderer_1, aurelia_pal_1) {
    ...
    var resources = {
        'ux-dialog': function () { return new Promise(function (resolve_1, reject_1) { require(['./resources/ux-dialog'], resolve_1, reject_1); }).then(function (m) { return m.UxDialog; }); },
        'ux-dialog-header': function () { return new Promise(function (resolve_2, reject_2) { require(['./resources/ux-dialog-header'], resolve_2, reject_2); }).then(function (m) { return m.UxDialogHeader; }); },
        'ux-dialog-body': function () { return new Promise(function (resolve_3, reject_3) { require(['./resources/ux-dialog-body'], resolve_3, reject_3); }).then(function (m) { return m.UxDialogBody; }); },
        'ux-dialog-footer': function () { return new Promise(function (resolve_4, reject_4) { require(['./resources/ux-dialog-footer'], resolve_4, reject_4); }).then(function (m) { return m.UxDialogFooter; }); },
        'attach-focus': function () { return new Promise(function (resolve_5, reject_5) { require(['./resources/attach-focus'], resolve_5, reject_5); }).then(function (m) { return m.AttachFocus; }); }
    };
        ...
        DialogConfiguration.prototype._apply = function () {
            ...
            if (this.resources.length) {
                return Promise.all(this.resources.map(function (name) { return resources[name](); }))
                    .then(function (modules) { _this.fwConfig.globalResources(modules); });
            }
        };
        /**
