...
var resources = {
    'ux-dialog': function () { return Promise.resolve().then(function () { return require('./resources/ux-dialog'); }); },
    'ux-dialog-header': function () { return Promise.resolve().then(function () { return require('./resources/ux-dialog-header'); }); },
    'ux-dialog-body': function () { return Promise.resolve().then(function () { return require('./resources/ux-dialog-body'); }); },
    'ux-dialog-footer': function () { return Promise.resolve().then(function () { return require('./resources/ux-dialog-footer'); }); },
    'attach-focus': function () { return Promise.resolve().then(function () { return require('./resources/attach-focus'); }); }
};
