System.register(["./renderer", "./dialog-settings", "./dialog-renderer", "aurelia-pal"], function (exports_1, context_1) {
    ...
    return {
        ...
        execute: function () {
            ...
            resources = {
                'ux-dialog': function () { return context_1.import('./resources/ux-dialog').then(function (m) { return m.UxDialog; }); },
                'ux-dialog-header': function () { return context_1.import('./resources/ux-dialog-header').then(function (m) { return m.UxDialogHeader; }); },
                'ux-dialog-body': function () { return context_1.import('./resources/ux-dialog-body').then(function (m) { return m.UxDialogBody; }); },
                'ux-dialog-footer': function () { return context_1.import('./resources/ux-dialog-footer').then(function (m) { return m.UxDialogFooter; }); },
                'attach-focus': function () { return context_1.import('./resources/attach-focus').then(function (m) { return m.AttachFocus; }); }
            };
