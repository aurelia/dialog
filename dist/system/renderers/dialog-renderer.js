...
System.register(['../dialog-options'], function (_export, _context) {
  var dialogOptions, currentZIndex, transitionEvent, DialogRenderer;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('DialogRenderer', DialogRenderer = function () {
