...
var resources = {
    ...
    'ux-dialog-footer': function () { return import('./resources/ux-dialog-footer').then(function (m) { return m.UxDialogFooter; }); },
    'attach-focus': function () { return import('./resources/attach-focus').then(function (m) { return m.AttachFocus; }); }
};
